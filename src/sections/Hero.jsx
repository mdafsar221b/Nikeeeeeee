    ...
    >
      <div className="relative xl:w-2/5 flex flex-col 
           ...
           max-xl:padding-x pt-28" >
            <p className='text-xl font-montserrat text-coral-red'>Our Summer Collectios</p>
            <h1 className='mt-10 font-palanquin text-8xl max-sm:text-[720px] max-sm:leadind-[82] font-bold '>
